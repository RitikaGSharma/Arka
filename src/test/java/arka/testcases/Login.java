...
public class Login extends BaseClass 
{
	...
	public void addNewLead(String uname,String pass,String name,String owner,String email,String phnNo,String property,String leadSource,String pipeline,String stage)
	{

		Loginpagen login=new Loginpagen(driver);
		login.loginToApplication(uname,pass);
		Leadspage leadspage = new Leadspage(driver);
		leadspage.addLead(name,owner, email,phnNo, property, leadSource, pipeline, stage);
	}
}
